  ...
  return (
    <section className="py-12 sm:py-16 md:py-24 bg-white relative overflow-hidden">
      ...
      <div className="container-max">
        ...
        {/* ======================================================================== */}
        {/* HORIZONTAL PIPELINE TRACK: PADDING & LINE BOUNDED TO NODE 1 & NODE 4     */}
        {/* ======================================================================== */}
        <div className="relative mb-8 sm:mb-12 md:mb-16 max-w-5xl mx-auto px-2 sm:px-6 md:px-8">
          {/* Connector line bounded strictly from center of Node 1 (12.5%) to center of Node 4 (87.5%) */}
          <div className="timeline-track top-[24px] sm:top-[28px] md:top-[34px] -translate-y-1/2 h-1 sm:h-1.5 pointer-events-none z-0">
            {/* Travelling Light Pulse across the bounded track */}
            ...
            {steps.map((step, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`timeline-icon-wrapper relative w-12 h-12 sm:w-14 sm:h-14 md:w-[68px] md:h-[68px] rounded-full flex items-center justify-center transition-all duration-500 border-2 z-10 ${
                      isActive
